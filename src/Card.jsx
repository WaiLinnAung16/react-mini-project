...
const Card = ({meal}) => {
  return (
    <div className=' w-60 border p-3 rounded-md flex flex-col justify-center items-center relative h-[380px] shadow-sm transition hover:shadow-lg hover:scale-105'>
